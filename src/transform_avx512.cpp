...
template<> \
transform<SIZE> * transform<SIZE>::create_avx512(const b_vec & b, const int n, const size_t num_regs) \
{ \
...
transform<VSIZE> * transform<VSIZE>::create_avx512(const b_vec & b, const int n, const size_t num_regs)
{
	return nullptr;
}
