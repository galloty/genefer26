...
Any number of the form *b*<sup>2<sup>*n*</sup></sup> + 1 such that 10,000 &le; *b* < 2,000,000,000 and 15 &le; *n* &le; 18 can be tested on GPU or CPU.  
...
The default settings are clang and linked to Boinc.  
